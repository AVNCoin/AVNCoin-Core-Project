Contributing to AVNcoin Core
============================

The AVNcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AVNcoin Core project, and is not to be
confused with overall AVNcoin Network Protocol consensus changes.

Whether a pull request is merged into AVNcoin Core rests with the project merge
...
Patches that change AVNcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AVNcoin consensus, it must have been
...
The project leader is the release manager for each AVNcoin Core release.
